...
func TestNamespace(t *testing.T) {
	...
	t.Run("TestGetNamespaces", func(t *testing.T) {
		...
		pkg.Expect(t, namespaces[0].UID, "9d0cdf8a-dedc-11e9-bf91-42010a800167")
		pkg.Expect(t, namespaces[0].Status, "")

		pkg.Expect(t, namespaces[1].Name, "beetle")
		pkg.Expect(t, namespaces[1].UID, "9d0cdf8a-dedc-11e9-bf91-42010a800168")
